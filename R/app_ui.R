               ...
               tabPanel("Krzywe wzrostu",
                        ...
                        sidebarLayout(
                          sidebarPanel(
                            ...
                            uiOutput("szczepy"),
                            uiOutput("warunki"),
                            radioButtons('smooth', 'Czy pokazać linię trendu (loess)?',
                                         choices = c('Tak', 'Nie'), inline = TRUE, selected = 'Nie'),
                            numericInput('span', 'Poziom wygładzenia loess (im wyższa wartość tym bardziej wygładzona linia)',
                            ...
                            radioButtons('ll', 'Czy pokazać dopasowanie modelu loglogistycznego? (tylko gdy wybrane są pojedyncze warunki)', 
                                         choices = c('Tak', 'Nie'), inline = TRUE, selected = 'Nie'),
                            radioButtons('hide_curves', 'Czy ukryć krzywe wzrostu?',
                                         choices = c('Tak', 'Nie'), inline = TRUE, selected = 'Nie'),
                            radioButtons('plot_type', 'Jaki wykres chcesz pobrać?', choices = list('png', 'svg'), 
                                         inline = TRUE),
                            downloadButton('download_wykres', 'Pobierz wykres'),
