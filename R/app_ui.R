                        ...
                        sidebarLayout(
                          sidebarPanel(
                            ...
                            conditionalPanel(condition = 'input.czy_filtr == "No"',
                                             ...
                                             radioButtons('format', "Choose bioscreen data type: excel file, csv/txt (generated by the bioscreen),
                                                          new bioscreen excel file?", 
                                                          choices = c('xlsx', 'csv', 'txt', 'new_xlsx'), inline = TRUE, selected = 'csv'),
               ...
               tabPanel("Growth curves",
                        ...
                        sidebarLayout(
                          sidebarPanel(
                            ...
                            uiOutput("szczepy"),
                            uiOutput("warunki"),
                            selectInput('viridis_option', 'Choose color scale', 
                                        choices = c('magma' = 'A', 'inferno' = 'B', 'plasma' = 'C', 'viridis' = 'D',
